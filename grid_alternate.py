...
axs[0].scatter(df['x'], df['y'], c=df['cluster_id'], cmap='turbo', s=0.5)
...
axs[0].scatter(mc_df['mass_center_x'], mc_df['mass_center_y'], c=mc_df['id'], cmap='turbo', alpha=0.6, edgecolors='k')  # Marking the centers
